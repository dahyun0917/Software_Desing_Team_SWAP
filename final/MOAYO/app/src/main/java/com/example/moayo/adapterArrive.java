...
public class adapterArrive extends RecyclerView.Adapter<adapterArrive.ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_recyclerview_arrive, parent, false);
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        ItemViewHolder(View itemView) {
            ...
            t1 = itemView.findViewById(R.id.text_arrival);
        }
