...
public class adapter extends RecyclerView.Adapter<adapter.ItemViewHolder> implements OnPersonItemClickListener {
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        ItemViewHolder(View itemView, final OnPersonItemClickListener listener) {
            super(itemView);
